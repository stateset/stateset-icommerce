...
fn to_f64_result<T>(value: T, field: &str) -> Result<f64, Error>
where
    T: TryInto<f64>,
    <T as TryInto<f64>>::Error: std::fmt::Display,
{
    value.try_into().map_err(|err| {
        Error::new(
            ...
            format!("Failed to convert {} to float: {}", field, err),
        )
    })
}

fn decimal_from_f64(value: f64, field: &str) -> Result<Decimal, Error> {
...
fn optional_decimal_from_f64(value: Option<f64>, field: &str) -> Result<Option<Decimal>, Error> {
    ...
    fn create(
        ...
        let wo = commerce
            ...
            .create(stateset_core::CreateWorkOrder {
                ...
                quantity_ordered: decimal_from_f64(quantity, "quantity")?,
                ..Default::default()
            })
            .map_err(|e| {
                Error::new(
...
impl CurrencyOps {
    ...
    fn convert(&self, amount: f64, from: String, to: String) -> Result<f64, Error> {
        ...
        let result = commerce
            .currency()
            .convert_amount(
                decimal_from_f64(amount, "amount")?,
        ...
        to_f64_result(result, "converted amount")
    }
    ...
    fn create(
        ...
        let promo = commerce
            ...
            .create(stateset_core::CreatePromotion {
                ...
                discount_value: decimal_from_f64(discount_value, "discount_value")?,
                ..Default::default()
            })
            .map_err(|e| {
...
impl Tax {
    fn calculate(
        ...
        let result = commerce
            .tax()
            .calculate_for_item(
                decimal_from_f64(unit_price, "unit_price")?,
        ...
        to_f64_result(result, "tax amount")
    }
