"""LangChain adapter helpers for the embedded commerce toolkit."""
...
def create_langchain_tools(
    ...
    """Create LangChain-compatible tools from a Commerce instance or toolkit."""

    toolkit = _resolve_toolkit(commerce_or_toolkit, allow_apply, capabilities)
    return toolkit.create_langchain_tools(filter=filter, tool_factory=tool_factory)
