...
impl Payments {
    ...
    fn create_refund(
        ...
        let uuid = payment_id.parse().map_err(|_| PyValueError::new_err("Invalid payment UUID"))?;
...
impl From<stateset_core::PurchaseOrder> for PurchaseOrder {
    fn from(po: stateset_core::PurchaseOrder) -> Self {
        Self {
            ...
            total_amount: to_f64_or_nan(po.total),
...
impl Carts {
    ...
    fn add_item(&self, cart_id: String, item: AddCartItemInput) -> PyResult<CartItem> {
        ...
        let uuid = cart_id.parse().map_err(|_| PyValueError::new_err("Invalid UUID"))?;
    ...
    fn update_item(&self, item_id: String, quantity: Option<i32>) -> PyResult<CartItem> {
        ...
        let uuid = item_id.parse().map_err(|_| PyValueError::new_err("Invalid UUID"))?;
    ...
    fn set_shipping_address(&self, id: String, address: CartAddress) -> PyResult<Cart> {
        ...
        let cart = commerce.carts().set_shipping_address(uuid, (&address).into()).map_err(|e| {
    ...
    fn set_billing_address(&self, id: String, address: CartAddress) -> PyResult<Cart> {
        ...
        let cart = commerce.carts().set_billing_address(uuid, (&address).into()).map_err(|e| {
...
impl Subscriptions {
    ...
    fn pause(&self, id: String, reason: Option<String>) -> PyResult<Subscription> {
        ...
        let subscription = commerce
            .subscriptions()
            .pause(uuid, stateset_core::PauseSubscription { reason, resume_at: None })
    ...
    fn get_events(&self, subscription_id: String) -> PyResult<Vec<SubscriptionEvent>> {
        ...
        let uuid = subscription_id.parse().map_err(|_| PyValueError::new_err("Invalid UUID"))?;
...
impl From<stateset_core::ApAgingSummary> for ApAgingSummary {
    fn from(s: stateset_core::ApAgingSummary) -> Self {
        Self {
            current: to_f64_or_nan(s.current),
            days_1_30: to_f64_or_nan(s.days_1_30),
            days_31_60: to_f64_or_nan(s.days_31_60),
            days_61_90: to_f64_or_nan(s.days_61_90),
            days_over_90: to_f64_or_nan(s.days_over_90),
            total: to_f64_or_nan(s.total),
        }
    }
}
...
impl From<stateset_core::InventoryValuation> for InventoryValuation {
    fn from(v: stateset_core::InventoryValuation) -> Self {
        Self {
            total_value: to_f64_or_nan(v.total_value),
            total_quantity: to_f64_or_nan(v.total_quantity),
            average_unit_cost: to_f64_or_nan(v.average_unit_cost),
        }
    }
}
