...
pub extern "C" fn stateset_order_ship(
    ...
    let result = use_handle(handle, |commerce| {
        commerce
            .orders()
            .update_status(uuid, OrderStatus::Shipped)
            .map_err(|e| e.to_string())
    });
...
pub extern "C" fn stateset_order_cancel(
    ...
    let result = use_handle(handle, |commerce| {
        commerce
            .orders()
            .update_status(uuid, OrderStatus::Cancelled)
            .map_err(|e| e.to_string())
    });
...
pub extern "C" fn stateset_payment_fail(
    ...
    let result = use_handle(handle, |commerce| {
        commerce
            .payments()
            .mark_failed(uuid, &reason_str, None)
            .map_err(|e| e.to_string())
    });
    ...
    let result = use_handle(handle, |commerce| {
        commerce
            ...
            .create(stateset_embedded::CreateWarranty {
                ...
                warranty_type: wtype,
                duration_months: if duration_months > 0 {
...
pub extern "C" fn stateset_warranty_deny_claim(
    ...
    let result = use_handle(handle, |commerce| {
        commerce
            .warranties()
            .deny_claim(claim_uuid, &reason_str)
            .map_err(|e| e.to_string())
    });
...
pub extern "C" fn stateset_lot_get_by_sku(
    ...
    let result = use_handle(handle, |commerce| {
        commerce
            .lots()
            .get_available_lots_for_sku(&sku_str)
            .map_err(|e| e.to_string())
    });
...
pub extern "C" fn stateset_serial_get_history(
    ...
    let result = use_handle(handle, |commerce| {
        commerce
            .serials()
            .get_history(uuid, Default::default())
            .map_err(|e| e.to_string())
    });
...
pub extern "C" fn stateset_fulfillment_create_pick_task(
    ...
    let result = use_handle(handle, |commerce| {
        ...
        commerce
            .fulfillment()
            .create_picks_for_order(order_uuid, 1)
            .map_err(|e| e.to_string())
    });
...
pub extern "C" fn stateset_ar_get_customer_aging(
    ...
    let result = use_handle(handle, |commerce| {
        commerce
            .accounts_receivable()
            .get_customer_aging(customer_uuid)
            .map_err(|e| e.to_string())
    });
...
pub extern "C" fn stateset_credit_get_account_by_customer(
    ...
    let result = use_handle(handle, |commerce| {
        commerce
            .credit()
            .get_credit_account_by_customer(customer_uuid)
            .map_err(|e| e.to_string())
    });
...
pub extern "C" fn stateset_credit_check(
    ...
    let result = use_handle(handle, |commerce| {
        commerce
            .credit()
            .check_credit(customer_uuid, amount)
            .map_err(|e| e.to_string())
    });
...
pub extern "C" fn stateset_credit_adjust_limit(
    ...
    let result = use_handle(handle, |commerce| {
        commerce
            .credit()
            .adjust_credit_limit(customer_uuid, limit, &reason_str)
            .map_err(|e| e.to_string())
    });
...
pub extern "C" fn stateset_gl_get_account_by_number(
    ...
    let result = use_handle(handle, |commerce| {
        commerce
            .general_ledger()
            .get_account_by_number(&number_str)
            .map_err(|e| e.to_string())
    });
...
pub extern "C" fn stateset_gl_post_journal_entry(
    ...
    let result = use_handle(handle, |commerce| {
        commerce
            .general_ledger()
            .post_journal_entry(uuid, "system")
            .map_err(|e| e.to_string())
    });
