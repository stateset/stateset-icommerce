...
Scaffold a full-featured commerce storefront powered by [StateSet](https://stateset.io) in seconds.
...
A production-ready Next.js 15 storefront with:

- **Embedded commerce engine** — products, carts, orders, inventory, subscriptions via `@stateset/embedded`
- **USDC payments** — native crypto checkout on Base chain via Wagmi + Viem
...
my-store/
  ...
  scripts/seed.js               # Seed 10 products + tax jurisdictions
```
