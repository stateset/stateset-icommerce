...
| **npm** | `npm install @stateset/embedded@1.34.0` |
| **PyPI** | `pip install stateset-embedded==1.34.0` |
| **CLI + MCP servers** | `npm install -g @stateset/cli@1.34.0` |
...
0.7.22, both far behind 1.34.0. PHP, Java, Kotlin, Swift, .NET, and Go have no
