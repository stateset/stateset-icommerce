...
pip install stateset-embedded==1.23.6     # Python
npm install @stateset/embedded@1.23.6     # Node.js
npm install -g @stateset/cli@1.23.6       # CLI
gem install stateset_embedded -v 1.23.6   # Ruby
```
...
- [What's New in v1.23.6](#whats-new-in-v1236)
...
```bash
npm install @stateset/embedded@1.23.6 @stateset/cli@1.23.6
```
...
## What's New in v1.23.6

**v1.23.6 completes the registry repair**: per-platform npm packages
...
**The v1.17.0 → v1.23.6 series makes the platform whole: full backend
...
- **Trunk health and financial-correctness fixes (v1.23.6).** First
...
- **Swift** — Swift Package Manager is the supported path. CocoaPods is
  community-maintained at `pod 'StateSet', '~> 1.23.6'`.
...
|----------|---------|---------|------|
| **Rust** | `stateset-sdk` / `stateset-embedded` | `cargo add stateset-sdk --features full` or `stateset-embedded = "1.23.6"` | [docs.rs](https://docs.rs/stateset-sdk) |
| **Node.js** | `@stateset/embedded` | `npm install @stateset/embedded@1.23.6` | [npm](https://www.npmjs.com/package/@stateset/embedded) |
...
| **Java** | `com.stateset:embedded` | `implementation 'com.stateset:embedded:1.23.6'` | [Maven Central](https://central.sonatype.com/artifact/com.stateset/embedded) |
| **Kotlin** | `com.stateset:embedded-kotlin` | `implementation("com.stateset:embedded-kotlin:1.23.6")` | [Maven Central](https://central.sonatype.com/artifact/com.stateset/embedded-kotlin) |
| **Swift** | `StateSet` | `.package(url: "https://github.com/stateset/stateset-swift.git", from: "1.23.6")` | [GitHub](https://github.com/stateset/stateset-swift) |
| **C# / .NET** | `StateSet.Embedded` | `dotnet add package StateSet.Embedded --version 1.23.6` / `<PackageReference Include="StateSet.Embedded" Version="1.23.6" />` | [NuGet](https://www.nuget.org/packages/StateSet.Embedded) |
| **Go** | `stateset` | `go get github.com/stateset/stateset-icommerce/bindings/go/stateset@v1.23.6` | [pkg.go.dev](https://pkg.go.dev/github.com/stateset/stateset-icommerce/bindings/go/stateset) |
