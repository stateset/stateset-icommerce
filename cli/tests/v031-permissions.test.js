/**
 * v0.6.0 Permission Sandboxing Tests
 *
 * Tests for:
...
describe('v0.6.0 — http-auth module (unit)', () => {
...
describe('v0.6.0 — HTTP Gateway auth integration', () => {
  let gw, port;
...
describe('v0.6.0 — Level enforcement', () => {
  let gw, port;
...
describe('v0.6.0 — Backwards compat (no apiKeys)', () => {
  let gw, port;
