...
export const AUDITED_CLASS_METHOD_TOOL_COVERAGE = Object.freeze({
  Customers: {
    ...
    methodToTools: {
      ...
      findOrCreate: ['find_or_create_customer'],
      addAddress: ['add_customer_address'],
      getAddresses: ['list_customer_addresses'],
      updateAddress: ['update_customer_address'],
      deleteAddress: ['delete_customer_address'],
      setDefaultAddress: ['set_default_customer_address'],
    },
  },
  Orders: {
    tools: orderTools,
  ...
  Products: {
    ...
    methodToTools: {
      ...
      getVariant: ['get_product_variant'],
      list: ['list_products'],
      count: ['list_products'],
      ...
      getBySlug: ['get_product_by_slug'],
      search: ['search_products'],
      getVariants: ['list_product_variants'],
      addVariant: ['add_product_variant'],
      updateVariant: ['update_product_variant'],
      deleteVariant: ['delete_product_variant'],
    },
  },
  CustomObjects: {
  ...
  Returns: {
    ...
    methodToTools: {
      ...
      complete: ['complete_return'],
      cancel: ['cancel_return'],
      addTracking: ['add_return_tracking'],
    },
  },
  Warranties: {
    tools: warrantyTools,
  ...
  Payments: {
    ...
    methodToTools: {
      ...
      createRefundExact: ['create_refund'],
      count: ['list_payments'],
    },
  },
  Shipments: {
