...
function buildPromptWithHistory(request, history, options = {}) {
...
function extractCompactionSummary(compactedHistory) {
...
function isRetryableError(error, retrySettings) {
...
function computeRetryDelay(attempt, retrySettings) {
