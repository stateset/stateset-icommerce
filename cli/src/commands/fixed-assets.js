/**
 * Fixed Assets Commands Module
 *
 * Tool-backed: dispatches to the fixed-assets MCP tool definitions so the CLI
...
import { fixedAssetTools } from '../tools/fixed-assets.js';
