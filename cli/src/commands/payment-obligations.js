/**
 * Payment Obligations Commands Module
 *
 * Tool-backed: dispatches to the payment-obligations MCP tool definitions so the CLI
...
import { paymentObligationTools } from '../tools/payment-obligations.js';
