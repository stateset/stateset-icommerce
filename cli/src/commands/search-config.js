/**
 * Search Config Commands Module
 *
 * Tool-backed: dispatches to the search-config MCP tool definitions so the CLI
...
import { searchConfigTools } from '../tools/search-config.js';
