/**
 * Vendor Credits Commands Module
 *
 * Tool-backed: dispatches to the vendor-credits MCP tool definitions so the CLI
...
import { vendorCreditTools } from '../tools/vendor-credits.js';
