/**
 * Price Schedules Commands Module
 *
 * Tool-backed: dispatches to the price-schedules MCP tool definitions so the CLI
...
import { priceScheduleTools } from '../tools/price-schedules.js';
