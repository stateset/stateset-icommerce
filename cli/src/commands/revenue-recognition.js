/**
 * Revenue Recognition Commands Module
 *
 * Tool-backed: dispatches to the revenue-recognition MCP tool definitions so the CLI
...
import { revenueRecognitionTools } from '../tools/revenue-recognition.js';
