...
export const TOOL_PERMISSIONS = {
  ...
  create_cart: 'write',
  update_cart: 'write',
  list_customer_carts: 'read',
  delete_cart: 'delete',
  add_cart_item: 'write',
  update_cart_item: 'write',
  remove_cart_item: 'delete',
  list_cart_items: 'read',
  clear_cart_items: 'delete',
  set_cart_shipping_address: 'write',
  set_cart_shipping: 'write',
  set_cart_billing_address: 'write',
  set_cart_payment: 'write',
  apply_cart_discount: 'write',
  remove_cart_discount: 'delete',
  get_shipping_rates: 'read',
  mark_cart_ready_for_payment: 'write',
  begin_cart_checkout: 'write',
  complete_checkout: 'write',
  cancel_cart: 'delete',
  abandon_cart: 'write',
  expire_cart: 'write',
  reserve_cart_inventory: 'write',
  release_cart_inventory: 'write',
  recalculate_cart: 'write',
  set_cart_tax: 'write',
  get_abandoned_carts: 'read',
  get_expired_carts: 'read',
  ...
  set_exchange_rates: 'admin',
  delete_exchange_rate: 'delete',
  get_currency_settings: 'read',
  update_currency_settings: 'admin',
  ...
  calculate_tax: 'read',
  get_tax_rate: 'read',
  calculate_item_tax: 'read',
  get_tax_jurisdiction: 'read',
  list_tax_jurisdictions: 'read',
  create_tax_jurisdiction: 'write',
  list_tax_rates: 'read',
  get_tax_rate_record: 'read',
  ...
  update_subscription_plan: 'write',
  ...
  submit_purchase_order: 'write',
  approve_purchase_order: 'write',
  send_purchase_order: 'write',
  cancel_purchase_order: 'write',
  ...
  deny_warranty_claim: 'write',
  complete_warranty_claim: 'write',

  // Quality
  list_inspections: 'read',
  get_inspection: 'read',
  create_inspection: 'write',
  start_inspection: 'write',
  complete_inspection: 'write',
  list_ncrs: 'read',
  get_ncr: 'read',
  create_ncr: 'write',
  close_ncr: 'write',
  list_quality_holds: 'read',
  get_quality_hold: 'read',
  create_quality_hold: 'write',
  release_quality_hold: 'write',
  list_active_quality_holds: 'read',
  count_active_quality_holds: 'read',

  // Lots
  list_lots: 'read',
  get_lot: 'read',
  create_lot: 'write',
  list_active_lots: 'read',
  list_available_lots_for_sku: 'read',
  quarantine_lot: 'write',
  release_lot_quarantine: 'write',
  list_expiring_lots: 'read',
  list_expired_lots: 'read',
  list_quarantined_lots: 'read',
  count_lots: 'read',
  ...
  get_serial: 'read',
  create_serial: 'write',
  list_available_serials: 'read',
  mark_serial_sold: 'write',
  quarantine_serial: 'write',
  check_serial_availability: 'read',
  count_serials: 'read',
  ...
  get_location: 'read',
  list_locations: 'read',
  list_pickable_locations: 'read',
  get_warehouse_sku_available_quantity: 'read',
  count_warehouses: 'read',

  // Receiving
  list_receipts: 'read',
  get_receipt: 'read',
  create_receipt: 'write',
  create_receipt_from_purchase_order: 'write',
  start_receiving: 'write',
  complete_receiving: 'write',
  cancel_receipt: 'write',
  count_receipts: 'read',

  // Fulfillment
  list_fulfillment_waves: 'read',
  get_fulfillment_wave: 'read',
  create_fulfillment_wave: 'write',
  release_fulfillment_wave: 'write',
  complete_fulfillment_wave: 'write',
  cancel_fulfillment_wave: 'write',
  list_pick_tasks: 'read',
  get_pick_task: 'read',
  assign_pick_task: 'write',
  start_pick_task: 'write',
  cancel_pick_task: 'write',
  check_order_ready_to_pack: 'read',
  check_order_ready_to_ship: 'read',
  count_fulfillment_waves: 'read',
  ...
  approve_bill: 'write',
  cancel_bill: 'write',
  list_overdue_bills: 'read',
  list_bills_due_soon: 'read',
  get_accounts_payable_aging_summary: 'read',
  get_accounts_payable_total_outstanding: 'read',
  count_accounts_payable_bills: 'read',

  // Accounts Receivable
  get_accounts_receivable_aging_summary: 'read',
  get_accounts_receivable_total_outstanding: 'read',
  get_days_sales_outstanding: 'read',
  list_credit_memos: 'read',
  get_credit_memo: 'read',
  create_credit_memo: 'write',
  void_credit_memo: 'write',
  list_unapplied_credits: 'read',

  // Cost Accounting
  list_item_costs: 'read',
  get_item_cost: 'read',
  set_item_cost: 'write',
  update_average_item_cost: 'write',
  get_total_inventory_value: 'read',

  // Credit
  list_credit_accounts: 'read',
  get_credit_account: 'read',
  create_credit_account: 'write',
  check_customer_credit: 'read',
  adjust_credit_limit: 'write',
  suspend_credit_account: 'write',
  reactivate_credit_account: 'write',
  list_over_limit_credit_accounts: 'read',

  // Backorders
  list_backorders: 'read',
  get_backorder: 'read',
  create_backorder: 'write',
  cancel_backorder: 'write',
  list_backorders_for_order: 'read',
  ...
  // --- Synced from tool-module `permission` metadata (v1.17.0-v1.22.0 domains).
  // Keep in lockstep with src/tools/*.js — test/unit/permissions.test.js enforces it.
  // accounts-payable.js
  three_way_match_bill: 'read',
  // activity-logs.js
  check_activity_logs_supported: 'read',
  list_activity_logs: 'read',
  get_activity_log: 'read',
  get_activity_history_for_subject: 'read',
  record_activity: 'write',
  // channels.js
  check_channels_supported: 'read',
  list_channels: 'read',
  get_channel: 'read',
  create_channel: 'write',
  update_channel: 'write',
  set_channel_lock: 'write',
  list_channel_product_mappings: 'read',
  delete_channel: 'write',
  // companies.js
  check_companies_supported: 'read',
  list_companies: 'read',
  get_company: 'read',
  create_company: 'write',
  update_company: 'write',
  list_company_addresses: 'read',
  ...
  find_or_create_customer: 'write',
  list_customer_addresses: 'read',
  add_customer_address: 'write',
  update_customer_address: 'write',
  delete_customer_address: 'write',
  set_default_customer_address: 'write',
  // cycle-counts.js
  list_cycle_counts: 'read',
  get_cycle_count: 'read',
  create_cycle_count: 'write',
  start_cycle_count: 'write',
  record_cycle_counts: 'write',
  complete_cycle_count: 'write',
  cancel_cycle_count: 'write',
  // edi-documents.js
  list_edi_documents: 'read',
  get_edi_document: 'read',
  create_edi_document: 'write',
  set_edi_document_status: 'write',
  get_edi_summary: 'read',
  // fixed-assets.js
  list_fixed_assets: 'read',
  get_fixed_asset: 'read',
  create_fixed_asset: 'write',
  place_asset_in_service: 'write',
  dispose_fixed_asset: 'write',
  write_off_fixed_asset: 'write',
  generate_depreciation_schedule: 'write',
  get_depreciation_schedule: 'read',
  post_depreciation: 'write',
  // general-ledger.js
  revalue_gl: 'write',
  close_month: 'write',
  create_gl_period: 'write',
  list_gl_periods: 'read',
  open_gl_period: 'write',
  // inbound-shipments.js
  check_inbound_shipments_supported: 'read',
  list_inbound_shipments: 'read',
  get_inbound_shipment: 'read',
  create_inbound_shipment: 'write',
  mark_inbound_shipment_in_transit: 'write',
  mark_inbound_shipment_arrived: 'write',
  receive_inbound_shipment_line: 'write',
  cancel_inbound_shipment: 'write',
  // integration-field-mappings.js
  list_integration_field_mappings: 'read',
  get_integration_field_mapping: 'read',
  list_integration_mapping_groups: 'read',
  create_integration_field_mapping: 'write',
  update_integration_field_mapping: 'write',
  bulk_create_integration_field_mappings: 'write',
  bulk_delete_integration_field_mappings: 'write',
  delete_integration_field_mapping: 'write',
  // integration-mappings.js
  list_integration_mappings: 'read',
  get_integration_mapping: 'read',
  resolve_integration_mapping: 'read',
  create_integration_mapping: 'write',
  update_integration_mapping: 'write',
  bulk_upsert_integration_mappings: 'write',
  delete_integration_mapping: 'write',
  // maintenance.js
  backup_database: 'write',
  restore_database: 'write',
  export_full_data: 'read',
  import_full_data: 'write',
  list_portable_domains: 'read',
  // payment-obligations.js
  list_payment_obligations: 'read',
  get_payment_obligation: 'read',
  get_payment_obligation_dashboard: 'read',
  create_payment_obligation: 'write',
  record_payment_obligation_payment: 'write',
  set_payment_obligation_status: 'write',
  link_payment_obligation_bill: 'write',
  // prepayments.js
  check_prepayments_supported: 'read',
  list_prepayments: 'read',
  get_prepayment: 'read',
  create_prepayment: 'write',
  apply_prepayment: 'write',
  list_prepayment_applications: 'read',
  reverse_prepayment_application: 'write',
  refund_prepayment: 'write',
  // price-levels.js
  check_price_levels_supported: 'read',
  list_price_levels: 'read',
  get_price_level: 'read',
  create_price_level: 'write',
  update_price_level: 'write',
  delete_price_level: 'write',
  set_price_level_entry: 'write',
  delete_price_level_entry: 'write',
  list_price_level_entries: 'read',
  // price-schedules.js
  check_price_schedules_supported: 'read',
  list_price_schedules: 'read',
  get_price_schedule: 'read',
  create_price_schedule: 'write',
  update_price_schedule: 'write',
  delete_price_schedule: 'write',
  set_price_schedule_entry: 'write',
  delete_price_schedule_entry: 'write',
  list_price_schedule_entries: 'read',
  resolve_scheduled_price: 'read',
  // print-stations.js
  list_print_stations: 'read',
  get_print_station: 'read',
  pair_print_station: 'write',
  revoke_print_station: 'write',
  list_print_jobs: 'read',
  enqueue_print_job: 'write',
  pick_up_next_print_job: 'write',
  complete_print_job: 'write',
  // production-batches.js
  check_production_batches_supported: 'read',
  list_production_batches: 'read',
  get_production_batch: 'read',
  create_production_batch: 'write',
  update_production_batch: 'write',
  delete_production_batch: 'write',
  add_production_batch_work_orders: 'write',
  remove_production_batch_work_order: 'write',
  // products.js
  get_product_by_slug: 'read',
  search_products: 'read',
  list_product_variants: 'read',
  update_product: 'write',
  activate_product: 'write',
  archive_product: 'write',
  delete_product: 'write',
  add_product_variant: 'write',
  update_product_variant: 'write',
  delete_product_variant: 'write',
  // purgatory.js
  list_purgatory_orders: 'read',
  get_purgatory_order: 'read',
  ingest_purgatory_order: 'write',
  map_purgatory_line: 'write',
  post_purgatory_order: 'write',
  delete_purgatory_order: 'write',
  // returns.js
  list_returns_for_order: 'read',
  list_returns_for_customer: 'read',
  list_pending_returns: 'read',
  mark_return_received: 'write',
  complete_return: 'write',
  cancel_return: 'write',
  add_return_tracking: 'write',
  // revenue-recognition.js
  list_revenue_contracts: 'read',
  get_revenue_contract: 'read',
  create_revenue_contract: 'write',
  generate_revenue_schedule: 'write',
  get_revenue_schedule: 'read',
  recognize_revenue: 'write',
  // search-config.js
  list_search_configs: 'read',
  get_search_config: 'read',
  get_active_search_config: 'read',
  create_search_config: 'write',
  update_search_config: 'write',
  set_active_search_config: 'write',
  delete_search_config: 'write',
  // stock-snapshots.js
  list_stock_snapshots: 'read',
  get_stock_snapshot: 'read',
  get_latest_stock_snapshot: 'read',
  capture_stock_snapshot: 'write',
  delete_stock_snapshot: 'write',
  // supplier-skus.js
  check_supplier_skus_supported: 'read',
  list_supplier_skus: 'read',
  get_supplier_sku: 'read',
  create_supplier_sku: 'write',
  update_supplier_sku: 'write',
  delete_supplier_sku: 'write',
  bulk_upsert_supplier_skus: 'write',
  // topology-snapshots.js
  list_topology_snapshots: 'read',
  get_topology_snapshot: 'read',
  get_latest_topology_snapshot: 'read',
  capture_topology_snapshot: 'write',
  delete_topology_snapshot: 'write',
  // transfer-orders.js
  check_transfer_orders_supported: 'read',
  list_transfer_orders: 'read',
  get_transfer_order: 'read',
  create_transfer_order: 'write',
  ship_transfer_order: 'write',
  receive_transfer_order_line: 'write',
  cancel_transfer_order: 'write',
  // units-of-measure.js
  list_unit_classes: 'read',
  create_unit_class: 'write',
  delete_unit_class: 'write',
  list_units_of_measure: 'read',
  create_unit_of_measure: 'write',
  set_base_unit_of_measure: 'write',
  delete_unit_of_measure: 'write',
  list_unit_conversion_rules: 'read',
  create_unit_conversion_rule: 'write',
  delete_unit_conversion_rule: 'write',
  // vendor-credits.js
  check_vendor_credits_supported: 'read',
  list_vendor_credits: 'read',
  get_vendor_credit: 'read',
  create_vendor_credit: 'write',
  apply_vendor_credit: 'write',
  list_vendor_credit_applications: 'read',
  reverse_vendor_credit_application: 'write',
  cancel_vendor_credit: 'write',
  // vendor-returns.js
  list_vendor_returns: 'read',
  get_vendor_return: 'read',
  create_vendor_return: 'write',
  submit_vendor_return: 'write',
  process_vendor_return: 'write',
  cancel_vendor_return: 'write',
};
