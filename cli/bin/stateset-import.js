#!/usr/bin/env node
/**
 * StateSet Import Agent
 *
 * Data import/export specialist for migrating from external commerce platforms.
 *
 * Usage:
 *   stateset-import "list id mappings for shopify"
 *   stateset-import --apply "import shopify data from CSV at ./exports/"
 *   stateset-import --apply "import products from products.json"
 */
...
installShutdownHandlers('stateset-import');
...
if (values.help) {
  console.log(`
StateSet Import Agent - Data Import & Export

Usage:
  stateset-import [options] "<request>"
...
Examples:
  stateset-import "list id mappings for shopify"
  stateset-import "check import status"
  stateset-import "export all customers as JSON"
  stateset-import --apply "import shopify data from api"
  stateset-import --apply "import products from products.csv"
  stateset-import --apply "import orders from orders.json"

Supported Platforms:
  shopify - Shopify (API, CSV export, JSON dump)
`);
  process.exit(0);
}
...
if (!request) {
  console.error('Usage: stateset-import [options] "<request>"');
