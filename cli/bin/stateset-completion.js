...
const COMMANDS = {
  ...
  'stateset-direct': {
    ...
    aliases: {
      c: 'customers', o: 'orders', p: 'products', i: 'inventory', r: 'returns',
      cust: 'customers', ord: 'orders', prod: 'products', inv: 'inventory', ret: 'returns'
    },
...
_stateset_complete() {
    ...
    local commands="stateset stateset-direct stateset-chat stateset-doctor stateset-config stateset-sync stateset-checkout stateset-orders stateset-inventory stateset-returns stateset-analytics stateset-promotions stateset-subscriptions stateset-create stateset-events"
    ...
    case "\${words[0]}" in
        ...
        stateset-direct)
            if [[ \${cword} -eq 1 ]]; then
                # Resources
                COMPREPLY=( $(compgen -W "customers orders products inventory returns c o p i r cust ord prod inv ret stock" -- "\${cur}") )
...
function generateZshCompletion() {
  return `#compdef stateset stateset-direct stateset-chat stateset-doctor stateset-config stateset-sync
...
complete -c stateset-direct -n '__fish_is_first_arg' -a 'c o p i r' -d 'Aliases'
