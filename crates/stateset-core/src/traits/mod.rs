...
use crate::models::{CreateOrder, Order, UpdateOrder, OrderFilter, CreateOrderItem, OrderItem, CreateInventoryItem, InventoryItem, StockLevel, InventoryBalance, AdjustInventory, InventoryTransaction, ReserveInventory, InventoryReservation, InventoryFilter, CreateCustomer, Customer, UpdateCustomer, CustomerFilter, CreateCustomerAddress, CustomerAddress, AddressType, CreateProduct, Product, UpdateProduct, ProductFilter, CreateProductVariant, ProductVariant, CreateReturn, Return, UpdateReturn, ReturnFilter, CreateBom, BillOfMaterials, UpdateBom, BomFilter, CreateBomComponent, BomComponent, CreateWorkOrder, WorkOrder, UpdateWorkOrder, WorkOrderFilter, CreateWorkOrderTask, WorkOrderTask, UpdateWorkOrderTask, AddWorkOrderMaterial, WorkOrderMaterial, CreateShipment, Shipment, UpdateShipment, ShipmentFilter, CreateShipmentItem, ShipmentItem, AddShipmentEvent, ShipmentEvent, CreatePayment, Payment, UpdatePayment, PaymentFilter, CreateRefund, Refund, CreatePaymentMethod, PaymentMethod, CreateWarranty, Warranty, UpdateWarranty, WarrantyFilter, CreateWarrantyClaim, WarrantyClaim, UpdateWarrantyClaim, WarrantyClaimFilter, ClaimResolution, CreateSupplier, Supplier, UpdateSupplier, SupplierFilter, CreatePurchaseOrder, PurchaseOrder, UpdatePurchaseOrder, PurchaseOrderFilter, ReceivePurchaseOrderItems, CreatePurchaseOrderItem, PurchaseOrderItem, CreateInvoice, Invoice, UpdateInvoice, InvoiceFilter, RecordInvoicePayment, CreateInvoiceItem, InvoiceItem, CreateCart, Cart, UpdateCart, CartFilter, AddCartItem, CartItem, UpdateCartItem, CartAddress, SetCartShipping, ShippingRate, SetCartPayment, SetCartX402Payment, X402CheckoutResult, CheckoutResult, AnalyticsQuery, SalesSummary, RevenueByPeriod, TopProduct, ProductPerformance, CustomerMetrics, TopCustomer, InventoryHealth, LowStockItem, InventoryMovement, OrderStatusBreakdown, FulfillmentMetrics, ReturnMetrics, DemandForecast, TimeGranularity, RevenueForecast, Currency, ExchangeRate, ExchangeRateFilter, SetExchangeRate, ConvertCurrency, ConversionResult, StoreCurrencySettings, CreateTaxJurisdiction, TaxJurisdiction, TaxJurisdictionFilter, CreateTaxRate, TaxRate, TaxRateFilter, TaxAddress, ProductTaxCategory, CreateTaxExemption, TaxExemption, TaxSettings, TaxCalculationRequest, TaxCalculationResult, CreatePromotion, Promotion, PromotionFilter, UpdatePromotion, CreateCouponCode, CouponCode, CouponFilter, ApplyPromotionsRequest, ApplyPromotionsResult, PromotionUsage, CreateSubscriptionPlan, SubscriptionPlan, SubscriptionPlanFilter, UpdateSubscriptionPlan, CreateSubscription, Subscription, SubscriptionFilter, UpdateSubscription, CancelSubscription, PauseSubscription, CreateBillingCycle, BillingCycle, BillingCycleFilter, BillingCycleStatus, SkipBillingCycle, SubscriptionEventType, SubscriptionEvent, CreateInspection, Inspection, UpdateInspection, InspectionFilter, RecordInspectionResult, InspectionItem, CreateNonConformance, NonConformance, UpdateNonConformance, NonConformanceFilter, CreateQualityHold, QualityHold, QualityHoldFilter, ReleaseQualityHold, CreateDefectCode, DefectCode, CreateLot, Lot, UpdateLot, LotFilter, AdjustLot, LotTransaction, ConsumeLot, ReserveLot, TransferLot, SplitLot, MergeLots, LotLocation, AddLotCertificate, LotCertificate, TraceabilityResult, CreateSerialNumber, SerialNumber, CreateSerialNumbersBulk, UpdateSerialNumber, SerialFilter, ChangeSerialStatus, ReserveSerialNumber, SerialReservation, MoveSerial, TransferSerialOwnership, SerialHistoryFilter, SerialHistory, SerialLookupResult, SerialValidation, CreateWarehouse, Warehouse, UpdateWarehouse, WarehouseFilter, CreateZone, Zone, UpdateZone, CreateLocation, Location, UpdateLocation, LocationFilter, LocationInventory, AdjustLocationInventory, MoveInventory, LocationMovement, LocationInventoryFilter, MovementFilter, CreateReceipt, Receipt, UpdateReceipt, ReceiptFilter, ReceiveItems, ReceiptItem, CreatePutAway, PutAway, PutAwayFilter, CompletePutAway, CreateWave, Wave, WaveFilter, CreatePickTask, PickTask, PickTaskFilter, CompletePick, CreatePackTask, PackTask, PackTaskFilter, AddCarton, Carton, AddCartonItem, CartonItem, CreateShipTask, ShipTask, ShipTaskFilter, CompleteShip, CreateBill, Bill, UpdateBill, BillFilter, BillItem, CreateBillItem, CreateBillPayment, BillPayment, BillPaymentFilter, PaymentAllocation, CreatePaymentRun, PaymentRun, PaymentRunFilter, ApAgingSummary, SupplierApSummary, ItemCost, SetItemCost, ItemCostFilter, CreateCostLayer, CostLayer, CostLayerFilter, IssueCostLayers, CostTransaction, CostTransactionType, CostTransactionFilter, RecordCostVariance, CostVariance, CostVarianceFilter, CreateCostAdjustment, CostAdjustment, CostAdjustmentFilter, CostRollup, CostMethod, InventoryValuation, SkuCostSummary, CreateCreditAccount, CreditAccount, UpdateCreditAccount, CreditAccountFilter, CreditCheckResult, PlaceCreditHold, CreditHold, CreditHoldFilter, ReleaseCreditHold, SubmitCreditApplication, CreditApplication, CreditApplicationFilter, ReviewCreditApplication, RecordCreditTransaction, CreditTransaction, CreditTransactionFilter, CustomerCreditSummary, CreditAgingBucket, CreateBackorder, Backorder, UpdateBackorder, BackorderFilter, FulfillBackorder, BackorderFulfillment, AllocateBackorder, BackorderAllocation, BackorderSummary, SkuBackorderSummary, ArAgingSummary, CustomerArAging, ArAgingFilter, CreateCollectionActivity, CollectionActivity, CollectionActivityFilter, CollectionStatus, DunningLetterType, CreateWriteOff, WriteOff, WriteOffFilter, CreateCreditMemo, CreditMemo, CreditMemoFilter, ApplyCreditMemo, ApplyPaymentToInvoices, ArPaymentApplication, CustomerArSummary, GenerateStatementRequest, CustomerStatement, CreateGlAccount, GlAccount, UpdateGlAccount, GlAccountFilter, CreateGlPeriod, GlPeriod, GlPeriodFilter, CreateJournalEntry, JournalEntry, JournalEntryFilter, JournalEntryLine, AutoPostingConfig, CreateAutoPostingConfig, TrialBalance, BalanceSheet, IncomeStatement, EntityType, VectorSearchResult, EmbeddingMetadata, EmbeddingStats, CreateX402PaymentIntent, X402PaymentIntent, SignX402PaymentIntent, X402PaymentIntentFilter, X402Asset, X402Network, X402CreditAccount, X402CreditAdjustment, X402CreditTransaction, X402CreditTransactionFilter, CreateAgentCard, AgentCard, UpdateAgentCard, AgentCardFilter, TrustLevel, CreateAgentIdentity, AgentIdentity, UpdateAgentIdentity, AgentWalletProofType, AgentIdentityFilter, AgentMetadataEntry, CreateAgentFeedback, AgentFeedback, AgentFeedbackFilter, FeedbackSummary, CreateAgentFeedbackResponse, AgentFeedbackResponse, CreateAgentValidationRequest, AgentValidationRequest, CreateAgentValidationResponse, AgentValidationResponse, AgentValidationStatus, ValidationSummary, CreateA2AQuote, SkillQuote, QuoteStatus, SkillQuoteFilter, CreateA2APurchase, A2APurchase, PurchaseStatus, A2APurchaseFilter, CreateCustomObjectType, CustomObjectType, UpdateCustomObjectType, CustomObjectTypeFilter, CreateCustomObject, CustomObject, UpdateCustomObject, CustomObjectFilter, CreateGiftCard, GiftCard, UpdateGiftCard, GiftCardFilter, GiftCardTransaction, CreateStoreCredit, StoreCredit, StoreCreditFilter, AdjustStoreCredit, StoreCreditTransaction, CreateSegment, Segment, UpdateSegment, SegmentFilter, SegmentMembership, CreateShippingZone, ShippingZone, UpdateShippingZone, ShippingZoneFilter, CreateZoneShippingMethod, ZoneShippingMethod, ZoneShippingMethodFilter, ZoneShippingRateRequest, ZoneShippingRate, CreateReview, Review, UpdateReview, ReviewFilter, ReviewSummary, CreateWishlist, Wishlist, UpdateWishlist, WishlistFilter, AddWishlistItem, WishlistItem, CreateLoyaltyProgram, LoyaltyProgram, EnrollCustomer, LoyaltyAccount, LoyaltyAccountFilter, AdjustPoints, LoyaltyTransaction, CreateReward, Reward, RewardFilter, CreateFraudAssessment, FraudAssessment, FraudAssessmentFilter, FraudDecision, CreateFraudRule, FraudRule, UpdateFraudRule, FraudRuleFilter, CreateSearchConfig, SearchConfig, UpdateSearchConfig, SearchConfigFilter};
