...
fn test_tax_thresholds_and_caps() {
    ...
    let result_low = commerce.tax().calculate(TaxCalculationRequest {
    ...
    let result_mid = commerce.tax().calculate(TaxCalculationRequest {
        line_items: vec![TaxLineItem {
            id: "item-mid".into(),
            quantity: dec!(1),
    ...
    let result_high = commerce.tax().calculate(TaxCalculationRequest {
        line_items: vec![TaxLineItem {
            id: "item-high".into(),
            quantity: dec!(1),
