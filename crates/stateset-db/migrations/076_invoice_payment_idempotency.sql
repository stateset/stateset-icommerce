-- Migration 076: Idempotency ledger for direct invoice payments
--
...
-- `record_payment` checks and writes it inside the payment's own transaction,
-- so a concurrent retry cannot slip between the check and the write.
--
