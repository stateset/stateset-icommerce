...
This book represents the **v0.9.7** documentation snapshot.

## Snapshot scope

This snapshot is frozen to the **v0.9.7** release line. For the latest docs
...
built and hosted under a stable path (for example, `/docs/v0.9.7/`).
