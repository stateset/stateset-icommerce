...
All 11 language bindings expose the same 41 domain APIs with consistent behavior. The Rust crate is the source of truth; bindings are generated from it.
...
| **Parity** | Every binding exposes the same 41 domain APIs |
...
| **Intelligence** | analytics, fraud, custom_objects, search_config |
