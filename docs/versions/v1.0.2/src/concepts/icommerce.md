...
This is not a simplified toy. The engine exposes a broad set of commerce and ERP domain surfaces, backed by a type-safe Rust core and a multi-layer runtime around it.
