...
This book represents the **v1.0.2** documentation snapshot.

## Snapshot scope

This snapshot is frozen to the **v1.0.2** release line. For the latest docs
...
built and hosted under a stable path (for example, `/docs/v1.0.2/`).
