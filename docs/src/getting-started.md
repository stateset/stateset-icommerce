...
```bash
npm install @stateset/embedded@1.0.4
```

### Python

```bash
pip install stateset-embedded==1.0.4
# or install optional framework adapters as well
pip install "stateset-embedded[agents]==1.0.4"
```

### CLI (global)

```bash
npm install -g @stateset/cli@1.0.4
...
```bash
npm install @stateset/cli@1.0.4 @stateset/embedded@1.0.4
```
