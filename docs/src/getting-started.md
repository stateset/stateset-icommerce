...
```bash
npm install @stateset/embedded@1.35.2
```

### Python

```bash
pip install stateset-embedded==1.35.2
...
```bash
npm install -g @stateset/cli@1.35.2
...
```bash
npm install @stateset/cli@1.35.2 @stateset/embedded@1.35.2
```
