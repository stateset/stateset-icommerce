...
```bash
npm install @stateset/embedded@1.35.0
```

### Python

```bash
pip install stateset-embedded==1.35.0
...
```bash
npm install -g @stateset/cli@1.35.0
...
```bash
npm install @stateset/cli@1.35.0 @stateset/embedded@1.35.0
```
