...
```bash
npm install @stateset/embedded@1.28.2
```

### Python

```bash
pip install stateset-embedded==1.28.2
# or install optional framework adapters as well
pip install "stateset-embedded[agents]==1.28.2"
```

### CLI (global)

```bash
npm install -g @stateset/cli@1.28.2
...
```bash
npm install @stateset/cli@1.28.2 @stateset/embedded@1.28.2
```
