...
```bash
npm install @stateset/embedded@1.28.3
```

### Python

```bash
pip install stateset-embedded==1.28.3
# or install optional framework adapters as well
pip install "stateset-embedded[agents]==1.28.3"
```

### CLI (global)

```bash
npm install -g @stateset/cli@1.28.3
...
```bash
npm install @stateset/cli@1.28.3 @stateset/embedded@1.28.3
```
