...
```bash
npm install @stateset/embedded@1.32.0
```

### Python

```bash
pip install stateset-embedded==1.32.0
# or install optional framework adapters as well
pip install "stateset-embedded[agents]==1.32.0"
```

### CLI (global)

```bash
npm install -g @stateset/cli@1.32.0
...
```bash
npm install @stateset/cli@1.32.0 @stateset/embedded@1.32.0
```
