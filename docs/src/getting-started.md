...
```bash
npm install @stateset/embedded@1.23.1
```

### Python

```bash
pip install stateset-embedded==1.23.1
# or install optional framework adapters as well
pip install "stateset-embedded[agents]==1.23.1"
```

### CLI (global)

```bash
npm install -g @stateset/cli@1.23.1
...
```bash
npm install @stateset/cli@1.23.1 @stateset/embedded@1.23.1
```
