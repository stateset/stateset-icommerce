...
StateSet iCommerce is a portable, AI-native commerce engine that runs in-process with zero external dependencies. Built on a type-safe Rust core with bindings for 11 platforms, it provides a complete commerce and ERP surface area as deterministic operations that AI agents can safely invoke.
...
| **11 Language Bindings** | Rust, Node.js, Python, Ruby, PHP, Java, Kotlin, Swift, .NET, Go, WASM |
