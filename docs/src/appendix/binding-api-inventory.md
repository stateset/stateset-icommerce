...
| PHP | Composer | `stateset/embedded` | `1.29.0` | `package-manifest` | manifest coverage |
| Python | PyPI | `stateset-embedded` | `1.29.0` | `detailed` | 244 public symbols |
| Ruby | RubyGems | `stateset_embedded` | `1.29.0` | `package-manifest` | manifest coverage |
| Swift | SwiftPM | `StateSet` | — | `detailed` | 71 API methods |
| WASM | npm | `@stateset/embedded-wasm` | `1.29.0` | `package-manifest` | manifest coverage |
