...
| --- | --- | --- | --- | --- | --- |
| .NET | NuGet | `StateSet.Embedded` | `1.23.6` | `detailed` | 245 API methods |
| Go | Go modules | `github.com/stateset/stateset-icommerce/bindings/go/stateset` | — | `detailed` | 80 API methods |
| Java | Maven | `com.stateset:embedded` | `1.23.6` | `package-manifest` | manifest coverage |
| Kotlin | Maven | `com.stateset:embedded-kotlin` | `1.23.6` | `package-manifest` | manifest coverage |
| Node.js | npm | `@stateset/embedded` | `1.23.6` | `detailed` | 6 export entrypoints |
| PHP | Composer | `stateset/embedded` | `1.23.6` | `package-manifest` | manifest coverage |
| Python | PyPI | `stateset-embedded` | `1.23.6` | `detailed` | 244 public symbols |
| Ruby | RubyGems | `stateset_embedded` | `1.23.6` | `package-manifest` | manifest coverage |
| Swift | SwiftPM | `StateSet` | — | `detailed` | 71 API methods |
| WASM | npm | `@stateset/embedded-wasm` | `1.23.6` | `package-manifest` | manifest coverage |
