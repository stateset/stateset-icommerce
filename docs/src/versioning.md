...
The current workspace release line is `v1.1.0`. The `v1` compatibility
...
**v1.1.0** — patch release for CLI outbound network security, remote
marketplace package validation, and BlueBubbles auth handling. See
`CHANGELOG.md` and `RELEASE_NOTES_v1.1.0.md` for the release narrative.
