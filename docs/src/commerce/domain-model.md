...
StateSet iCommerce provides 41 domain APIs covering the full commerce and ERP surface area. All APIs are available in every language binding with consistent behavior.
...
| `search_config` | Search configuration | Configure search weights and indexing |
