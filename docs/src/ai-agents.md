...
```bash
npm install @stateset/cli@1.6.0 @stateset/embedded@1.6.0
```

For Python runtimes:

```bash
pip install stateset-embedded==1.6.0
pip install "stateset-embedded[agents]==1.6.0"
```
...
```json
{
    "mcpServers": {
        "stateset-commerce": {
            "command": "npx",
            "args": ["@stateset/cli@1.6.0", "stateset-mcp", "--db", "./store.db"]
        }
    }
}
```
