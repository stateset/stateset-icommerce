...
# Or build a jar:
./gradlew jar
java -jar build/libs/kotlin-1.22.0.jar
```
...
# Or compile manually
javac -d . -cp path/to/stateset-embedded-1.22.0.jar BasicUsage.java
java -cp .:path/to/stateset-embedded-1.22.0.jar com.stateset.examples.BasicUsage
```
